...
CHECK((solve((x^2) + 4*x +2 == 0)) == (-2-sqrt(2) || -2+sqrt(2)));
CHECK((solve((x^2) + x == 2)) == (1 || -2));
CHECK((solve(x == 3)) == 3);
CHECK((solve(4*x + 5 == 8)) == 3/4);
CHECK((solve(x^2 + 2 == 4)) ==  (sqrt(2) || sqrt(2)));
CHECK((solve((x^2) + 2*x == 16 )) == (-1+ sqrt(17) || -1 - sqrt(17)));
CHECK((solve(x + 4 == 8)) == 4);
CHECK((solve((x^2) +3*x + 2 == 0)) == (-1 || -2));
CHECK_THROWS(solve((x^2) +3*x + 5 == 0));
CHECK_THROWS(solve(2*(x^2) +4*x + 5 == 0));
CHECK_THROWS(solve((x^2) + 3*x + 10 == 0));
CHECK((solve(3*(x^2) -10*x + 7 == 7)) == (0 || 10/3));
CHECK((solve(4*(x^2) -5*x + 7 == 6)) == (1 || 1/4));
CHECK((solve(10*x + 10 == 5*x)) == -2);
CHECK(solve(2*x + 9 == (x^2)) == (1+sqrt(10) || 1 - sqrt(10)));
CHECK(solve((2/3)*x + 9 == x) == 27);
CHECK(solve((2/3)*x + 1/5 == x) == 3/5);
CHECK(solve(5*x + 3 == -2*(x^2)) == (-2/3 || -1));
...
CHECK_THROWS(solve(5*x + 1  == -8*(x^2)));
    ...
    CHECK(solve((x^2)-16==0) == 4 || -4);
    CHECK(solve((x^2) +8*x+12 ==0) == -2 || 2);
    CHECK(solve((x^2)-16==0) == 4 || -4);
    CHECK(solve((x^2)+8*x-9==0) == -9 ||  1);
    CHECK(solve((x^2)+-10*x+16==0) == 2 || 8);
...
TEST_CASE("Test ComplexVariable") { //23
    ...
    CHECK(solve(5*(y^2) +2  == -5*y) == (complex<double>(-1/2,(sqrt(15))/10)) || complex<double>(-1/2,(-sqrt(15))/10));
    CHECK(solve(5*(y^2) +3  == -5*y) == (complex<double>(-1/2,(sqrt(35))/10)) || complex<double>(-1/2,(-sqrt(35))/10));
    CHECK(solve(10*(y^2) +3  == -5*y) == (complex<double>(-1/4,(sqrt(95))/20)) || complex<double>(-1/4,(-sqrt(95))/20));
    CHECK(solve(10*(y^2) +3  == -5*y -5) == (complex<double>(-1/4,(sqrt(295))/20)) || complex<double>(-1/4,(-sqrt(295))/20));
    CHECK(solve(10*(y^2) +3  == -5*y -5 -10) == (complex<double>(-1/4,(sqrt(695))/20)) || complex<double>(-1/4,(-sqrt(695))/20));
    CHECK(solve(10*(y^2) +8*y  == -5*y -5 -10) == (complex<double>(-13/20,(sqrt(431))/20)) || complex<double>(-13/20,(-sqrt(431))/20));
    CHECK(solve(5*(y^2) +8*y  == -5*y -30) == (complex<double>(-13/10,(sqrt(431))/10)) || complex<double>(-13/10,(-sqrt(431))/10));
    CHECK(solve(5*(y^2) +8*y  == -5*y -30 -5) == (complex<double>(-13/10,(3*sqrt(59))/10)) || complex<double>(-13/10,(-3*sqrt(59))/10));
    CHECK(solve(5*(y^2) +9*y  == -5*y -30 -5) == (complex<double>(-7/5,(3*sqrt(14))/5)) || complex<double>(-7/5,(-3*sqrt(14))/5));
